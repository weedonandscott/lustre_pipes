...
///
pub fn animate() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "animate")
}

///
pub fn animate_motion() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "animateMotion")
}

///
pub fn animate_transform() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "animateTransform")
}

///
pub fn mpath() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "mpath")
}

///
pub fn set() -> ChildlessScaffold(msg) {
...
///
pub fn circle() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "circle")
}

///
pub fn ellipse() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "ellipse")
}

///
pub fn line() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "line")
}

///
pub fn polygon() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "polygon")
}

///
pub fn polyline() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "polyline")
}

///
pub fn rect() -> ChildlessScaffold(msg) {
...
///
pub fn linear_gradient() -> Scaffold(msg) {
  scaffold.namespaced(namespace:, tag: "linearGradient")
}

///
pub fn radial_gradient() -> Scaffold(msg) {
  scaffold.namespaced(namespace:, tag: "radialGradient")
}

///
pub fn stop() -> ChildlessScaffold(msg) {
...
///
pub fn image() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "image")
}

///
pub fn path() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "path")
}

///
pub fn text() -> Scaffold(msg) {
  scaffold.namespaced(namespace:, tag: "text")
}

///
pub fn use_() -> ChildlessScaffold(msg) {
...
///
pub fn fe_distant_light() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "feDistantLight")
}

///
pub fn fe_point_light() -> ChildlessScaffold(msg) {
  scaffold.namespaced(namespace:, tag: "fePointLight")
}

///
pub fn fe_spot_light() -> ChildlessScaffold(msg) {
